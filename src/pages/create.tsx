...
export default function Example() {
  ...
  const handlePropertySubmit = () => {
    ...
    let propertiesFromLocalStorage = JSON.parse(localStorage.getItem("properties")) ? [].push(JSON.parse(localStorage.getItem("properties"))) : [];
    ...
    propertiesFromLocalStorage.push({
		...
		localStorage.setItem(
			'properties',
			JSON.stringify(propertiesFromLocalStorage)
    );
				...
				<div className="flex flex-col w-64">
					...
					<div className="flex flex-col flex-1 h-0 p-2 bg-gray-800">
						...
						<div className="flex items-center h-16 bg-gray-800 shrink-0 px-7">
							<label htmlFor="context" className="block text-sm text-gray-600 font-2xl">
								Context
							</label>
						</div>
									...
									<>
										<div>
											<Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-gray-900 border border-gray-300 rounded-md shadow-sm cursor-default focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-300 sm:text-sm">
												<span className="block text-white truncate">{selected?.name}</span>
												...
												>
													{people.map((person) => (
														<Listbox.Option
															...
															className={({ active }) =>
																classNames(
																	active ? "text-white bg-indigo-300" : "text-gray-900",
				...
				<main className="relative flex-1 overflow-y-auto focus:outline-none">
					<div className="py-6">
						<div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
							<h1 className="text-2xl font-semibold text-gray-900">Create new Property</h1>
							<div className="p-3">
								<button
									type="button"
								...
								>
									<QuestionMarkCircleIcon className="-ml-0.5 mr-2 h-4 w-4" aria-hidden="true" />
									Help
								</button>
							</div>
						</div>
						<div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
							...
							{
								// property
								<div className="flex px-4 mx-auto" style={{ flexDirection: "column" }}>
									<div>
												...
												<div className="py-2">
													<div>
														<dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
															...
															>
																<h6 className="p-2" style={{ textAlign: "center" }}>
																	English
																</h6>
																<fieldset>
																	<div>
												...
												<div className="sm:col-span-3">
													...
													<div className="mt-1">
														<input
															type="number"
															name="currencycode"
															value={propertyAddress.currencyCode}
															onChange={(e) => {
																setPropertyAddress({
																	...propertyAddress,
